...
function RouterNode({ data }) {
  return (
    <div className="flex items-center justify-center px-5 py-3 rounded-xl border-2 border-primary bg-primary/5 shadow-md min-w-[130px]">
      ...
      <img src="/branding/9router-v3-logo.png" alt="9Router V3" className="w-6 h-6 mr-2 object-contain" />
      <span className="text-sm font-bold text-primary">9Router V3</span>
      {data.activeCount > 0 && (
