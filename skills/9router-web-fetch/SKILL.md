...
description: Fetch URL → markdown / text / HTML via 9Router V3 /v1/web/fetch using Firecrawl / Jina Reader / Tavily Extract / Exa Contents. Use when the user wants to scrape a webpage, extract URL content, read article, or convert a URL to markdown.
---

# 9Router V3 — Web Fetch
